...
{
    internal sealed class EventMapInfoExact : IEventMapInfo
    {
    ...
    internal sealed class EventMapInfoExact<T1> : IEventMapInfo
    {
        private EventDispatcherWithCommandProcessing _dispatcher;
    ...
    internal sealed class EventMapInfoExact<T1, T2> : IEventMapInfo
    {
        private EventDispatcherWithCommandProcessing _dispatcher;
    ...
    internal sealed class EventMapInfoExact<T1, T2, T3> : IEventMapInfo
    {
        private EventDispatcherWithCommandProcessing _dispatcher;
