...
{
    public sealed class Command03SequenceTests
    {
        ...
        public void FailFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Fail>().To<Command03Fail>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void ExceptionTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Exception>().To<Command03>().InSequence();
        ...
        public void ExceptionOnFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Exception>().To<Command03>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 0, "1", null);
        ...
        public void ExceptionFailFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Exception>().To<Command03Fail>().To<Command03Fail>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void FailExceptionFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Fail>().To<Command03Exception>().To<Command03Fail>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void FailFailExceptionTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Fail>().To<Command03Fail>().To<Command03Exception>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void SuccessFailSuccessTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Fail>().To<Command03>().OnFail(CommandTestEvent.EventFail).InSequence();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void OnceFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Fail>().To<Command03Copy>().OnFail(CommandTestEvent.EventFail).InSequence().Once();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
            _dispatcher.Dispatch(CommandTestEvent.Event03, 5, "1", null);
        ...
        public void OnceExceptionTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Exception>().To<Command03Copy>().InSequence().Once();
        ...
        public void OnceExceptionOnFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03Exception>().To<Command03Copy>().OnFail(CommandTestEvent.EventFail).InSequence().Once();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
            _dispatcher.Dispatch(CommandTestEvent.Event03, 5, "1", null);
        ...
        public void OnceRetainReleaseTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Retain>().To<Command03>().InSequence().Once();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void OnceRetainFailTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Retain>().To<Command03>().OnFail(CommandTestEvent.EventFail).InSequence().Once();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03Retain>().To<Command03>().InSequence();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainFailTest()
        {
            ...
            Command03Retain.OnExecute += (param01, param02, param03) => { indexes.Add(0); };
            Command03Retain.OnFail += () => { indexes.Add(1); };
            Command03.OnExecute += (param01, param02, param03) => { indexes.Add(2); };
            CommandFailHandler.OnExecute += e => { indexes.Add(3); };
            
            _binder.Bind(CommandTestEvent.Event03).To<Command03Retain>().To<Command03>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainReleaseInstantTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03RetainReleaseInstant>().To<Command03>().OnComplete(CommandTestEvent.Event03Complete).InSequence();
            _binder.Bind(CommandTestEvent.Event03Complete).To<Command03Copy>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainReleaseInstantInTheEndTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03RetainReleaseInstant>().OnComplete(CommandTestEvent.Event03Complete).InSequence();
            _binder.Bind(CommandTestEvent.Event03Complete).To<Command03Copy>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainFailInstantTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03RetainFailInstant>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainExceptionInstantTest()
        {
            ...
            _binder.Bind(CommandTestEvent.Event03).To<Command03>().To<Command03RetainExceptionInstant>().OnFail(CommandTestEvent.EventFail).InSequence();
            _binder.Bind(CommandTestEvent.EventFail).To<CommandFailHandler>();
            _dispatcher.Dispatch(CommandTestEvent.Event03, 10, "1", null);
        ...
        public void RetainBreakTest()
        {
            ...
            Command03Retain.OnExecute += (param01, param02, param03) => { countRetain++; };
            Command03.OnExecute += (param01, param02, param03) => { count++; };
            Command03Copy.OnExecute += (param01, param02, param03) => { countBreak++; };

            _binder.Bind(CommandTestEvent.Event03)
                   .To<Command03Retain>()
                   .To<Command03>()
                   .OnBreak(CommandTestEvent.Event03Complete)
                   .InSequence();

            _binder.Bind(CommandTestEvent.Event03Complete)
                   .To<Command03Copy>();
